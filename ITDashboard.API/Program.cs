...
//        var errorMessage = $"[{DateTime.Now}] CRASH ON PATH: {context.Request.Path}\n" +
//                           $"Error: {ex.Message}\n" +
...
//        Console.WriteLine($"❌ Dashboard Route Crashed: {context.Request.Path} -> {ex.Message}");
//        throw;
//    }
//});
...
//if (isProduction)
//{
//    // UAT/Prod: no /api prefix, controllers are at root
//    // Nothing to do — default routing works
//}
//app.MapControllers();
